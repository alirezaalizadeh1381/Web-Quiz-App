...
namespace WebQuizApp.Migrations
{
    ...
    [Migration("20250728205644_AllowMultipleTestAttemps")]
    partial class AllowMultipleTestAttemps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebQuizApp.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebQuizApp.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebQuizApp.Models.UserTestResult", b =>
                {
                    ...
                    b.HasOne("WebQuizApp.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
